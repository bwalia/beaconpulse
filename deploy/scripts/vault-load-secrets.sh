...
for k in BEACON_AI_API_KEY BEACON_GOOGLE_CLIENT_ID STRIPE_SECRET_KEY STRIPE_PUBLISHABLE_KEY STRIPE_WEBHOOK_SECRET STRIPE_PRICE_STARTER STRIPE_PRICE_PRO \
  BEACON_DEFAULT_SMTP_HOST BEACON_DEFAULT_SMTP_PORT BEACON_DEFAULT_SMTP_FROM BEACON_DEFAULT_SMTP_USERNAME BEACON_DEFAULT_SMTP_PASSWORD BEACON_DEFAULT_SMTP_SECURITY; do
