#!/usr/bin/env bash
#
# load-ios-vault-secrets.sh — pull SysOps 24/7 iOS signing material from Vault.
#
# Reads the flat KV v2 secret `secret/beaconpulse/ios` (override with
# BEACONPULSE_IOS_VAULT_PATH), materialises the App Store Connect API key as a
# file, and exports identifiers for fastlane.
#
...
VAULT_SECRET_PATH="${BEACONPULSE_IOS_VAULT_PATH:-secret/beaconpulse/ios}"
...
secret_path = os.environ.get("VAULT_SECRET_PATH", "secret/beaconpulse/ios")
