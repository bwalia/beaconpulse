...
codebase ships any brand (SysOps 24/7, Uptimely, Beacon, …) — branding is **pure
...
Then in Xcode:
1. Pick the **SysOps**, **Uptimely** or **Beacon** scheme.
...
(SysOps 24/7 → `com.sysops247.app`, Uptimely → `org.uptimely.app`) on every push to
