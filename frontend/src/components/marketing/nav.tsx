          ...
          {!loading &&
            (user ? (
              ...
              <>
                <Link
                  href="/login"
                  className="hidden rounded-lg px-4 py-2.5 text-lg font-medium text-slate-700 transition-colors hover:text-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 motion-reduce:transition-none sm:inline-flex dark:text-slate-300 dark:hover:text-white"
                >
                  Sign in
                </Link>
                <Link
